...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | Portfolio</title>
            ...
            <meta name="keywords" content="500, internal server error, Carlos Timotheus, Portfolio,broken link ,missing page,link not found" />
        </Head>
    );
}
